...
exports.generateWantedPoster = generateWantedPoster;
...
async function generateWantedPoster(user, bountyAmount, locale = "en-US") {
    const width = 600;
    const height = 800;
    ...
    ctx.shadowOffsetX = 3;
    ctx.shadowOffsetY = 3;
    ctx.fillText((0, i18n_1.tLocale)(locale, "wanted_poster_title"), width / 2, 115);
    ctx.shadowBlur = 0;
    ctx.shadowOffsetX = 0;
    ctx.shadowOffsetY = 0;
    ctx.strokeStyle = darkBrown;
    ...
    ctx.fillText((0, i18n_1.tLocale)(locale, "wanted_poster_reward"), width / 2, 535);
    ...
    ctx.fillText((0, i18n_1.tLocale)(locale, "wanted_poster_silver"), width / 2, 645);
    ctx.shadowBlur = 0;
    ctx.strokeStyle = mediumBrown;
    ctx.lineWidth = 2;
    ctx.setLineDash([8, 4]);
    ...
    ctx.fillText((0, i18n_1.tLocale)(locale, "wanted_poster_dead_or_alive"), width / 2, 710);
    for (let i = 0; i < 4; i++) {
...
//# sourceMappingURL=wantedPoster.js.map