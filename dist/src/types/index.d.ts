import { SlashCommandBuilder, SlashCommandOptionsOnlyBuilder, SlashCommandSubcommandsOnlyBuilder, ChatInputCommandInteraction, Collection } from "discord.js";
/**
...
export type ItemType = "currency" | "resource" | "tool" | "consumable" | "treasure" | "special";
/**
 * Mining system
 */
 ...
 * Logger event types
 */
export type LogEventType = "command" | "error" | "warning" | "transaction" | "bounty" | "mining" | "admin";
...
export declare class EconomyError extends BotError {
    constructor(message: string, details?: Record<string, any>);
}
export declare class InventoryError extends BotError {
    constructor(message: string, details?: Record<string, any>);
}
export declare class DatabaseError extends BotError {
    constructor(message: string, details?: Record<string, any>);
}
export declare class GuildError extends BotError {
    constructor(message: string, details?: Record<string, any>);
}
/**
