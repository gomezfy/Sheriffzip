...
- **Weapon Shop (/armaria):** Interactive weapon store with carousel navigation, visual weapon cards generated with Canvas, and integration with the inventory system. Features 3 weapons: Escopeta (damage: 85), Revólver de Vaqueiro (damage: 65), and Revólver Calibre 38 (damage: 55). Also includes hunting/fishing equipment: Rifle de Caça (7,500 coins, 30 durability) and Vara de Pesca (3,500 coins, 40 durability).
