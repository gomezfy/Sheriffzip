...
async function showPartyInvite(interaction, leaderId, duration, pendingParties) {
    ...
    partyCollector.on("collect", async (i) => {
        ...
        // Start party expedition
            ...
            await startExpedition(i, party.leader, Array.from(party.members), party.duration, expeditionData);
...
async function startExpedition(interaction, leaderId, members, duration, expeditionData) {
    await interaction.deferUpdate();
