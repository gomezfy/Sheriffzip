...
async function execute(interaction) {
    ...
    const result = (0, warnManager_1.addWarn)(target.id, interaction.guild.id, interaction.user.id, reason);
    await (0, modLogs_1.logWarn)(interaction.guild, target, interaction.user, reason, result.totalWarns);
