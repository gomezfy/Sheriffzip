...
exports.commandLocalizations = void 0;
exports.applyLocalizations = applyLocalizations;
exports.commandLocalizations = {
    // Utility Commands
    ping: {
        name: {
            "pt-BR": "ping",
    ...
    hunt: {
        ...
        description: {
            "pt-BR": "Caçar animais selvagens no velho oeste",
            "en-US": "Hunt wild animals in the wild west",
        },
    },
    // Gambling Commands
    bankrob: {
...
function applyLocalizations(builder, commandName) {
    const localization = exports.commandLocalizations[commandName];
    if (!localization) {
...
//# sourceMappingURL=commandLocalizations.js.map