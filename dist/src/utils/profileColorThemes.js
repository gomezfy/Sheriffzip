...
exports.getThemeNameLocalized = getThemeNameLocalized;
...
const DEFAULT_THEME = exports.COLOR_THEMES[0];
function getThemeById(themeId) {
    const theme = exports.COLOR_THEMES.find((t) => t.id === themeId);
    if (!theme) {
...
function getThemeNameLocalized(themeId, locale) {
    const theme = getThemeById(themeId);
    const localeKey = locale;
    return theme.nameLocalized[localeKey] || theme.nameLocalized["en-US"];
}
//# sourceMappingURL=profileColorThemes.js.map