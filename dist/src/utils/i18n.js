...
const translations = {
    "pt-BR": {
        ...
        auto_daily_reward_desc: "*O xerife passou pela cidade e deixou um presente para você!*\n\n" +
            "╭─────────────────╮\n" +
        ...
        auto_daily_reward_footer: "Próximas recompensas amanhã às {hour}:00 • Sheriff Rex",
        auto_daily_inventory_full_title: "⚠️ Inventário Cheio!",
        auto_daily_inventory_full_desc: "*O xerife tentou entregar suas recompensas, mas sua mochila está lotada!*\n\n" +
        ...
        mine_blocked_expedition_desc: "Você não pode minerar enquanto estiver em uma expedição ativa. Complete a expedição primeiro!",
        mine_blocked_expedition_footer: "Volte quando a expedição terminar para minerar novamente.",
        ...
        bankrob_success_desc: "**{user1}** e **{user2}** conseguiram assaltar o banco e escapar!\n\nVocês conseguiram escapar com o saque!",
        ...
        roubo_warning_text: "Se o roubo falhar, TODOS os participantes ficarão procurados!",
        ...
        roubo_need_silver: "❌ Você precisa de **{amount}** Silver Coins para participar deste roubo!",
        roubo_in_jail: "🔒 Você está preso e não pode participar!",
        roubo_group_complete: "🎯 Grupo completo! Iniciando o roubo...",
        roubo_time_expired: "⏰ Tempo esgotado! Não foi possível reunir jogadores suficientes.",
        roubo_starting: "🐄 INICIANDO ROUBO DE GADO!",
        roubo_in_progress: "⚙️ O grupo está roubando gado...",
        roubo_progress_desc: "🤫 Os cowboys estão trabalhando silenciosamente para roubar o gado sem serem vistos!",
        ...
        roubo_success_desc: "🐴 O grupo roubou {cattle} cabeças de gado!\n\nVocês conseguiram escapar sem serem vistos e dividiram o gado!",
        roubo_distribution: "📦 Distribuição do Gado",
        roubo_added_inventory: "✅ O gado foi adicionado ao inventário de cada participante!",
        ...
        roubo_insufficient_silver: "❌ Um dos participantes não tem silver suficiente! Roubo cancelado.",
        roubo_random_word: "🎲 aleatório",
        roubo_progress_label: "📊 Progresso",
        roubo_in_jail_cooldown: "🔒 Você está preso!",
        roubo_cooldown_wait: "⏰ Aguarde {time} segundos antes de tentar outro roubo!",
        roubo_time_remaining_punishment: "⏱️ Tempo restante",
        roubo_cattle_word: "gado",
        roubo_entry_fee_required: "❌ Você precisa de **{amount}** Silver Coins para participar deste roubo!",
        // Middleman Command
        ...
        territories_browser_closed: "Navegador de territórios fechado. Volte a qualquer momento!",
        // Territory Rarities
        rarity_common: "Comum",
        rarity_rare: "Raro",
        rarity_epic: "Épico",
        ...
        territory_saloon_business_desc: "Possua um saloon movimentado no coração da cidade! Sirva bebidas, organize eventos e veja as moedas chegarem.",
        territory_saloon_business_benefit_1: "💰 Gere 5.000 Moedas de Prata diariamente",
        territory_saloon_business_benefit_2: "",
        territory_gold_mine_shares_name: "Ações da Mina de Ouro",
        territory_gold_mine_shares_desc: "Invista na mina de ouro mais rica do Oeste! Suas ações trarão renda constante de metais preciosos.",
        territory_gold_mine_shares_benefit_1: "💰 Gere 12.000 Moedas de Prata diariamente",
        territory_gold_mine_shares_benefit_2: "⚡ Operações de mineração 50% mais rápidas",
        territory_ranch_name: "Rancho",
        territory_ranch_desc: "Construa seu próprio rancho com gado, cavalos e planícies abertas. O verdadeiro sonho de um cowboy!",
        ...
        duel_challenge_desc: "**{challenger}** desafia **{opponent}** para um duelo de cowboys!\n\n{bet_info}⏰ Aceite dentro de 60 segundos!",
        ...
        duel_participants_only: "Apenas os participantes do duelo podem usar estes botões!",
        ...
        duel_action_attack_cover: "**{user}** dispara um tiro rápido mas **{target}** está protegido!",
        duel_action_defend: "**{user}** se esconde atrás de um barril!",
        duel_action_special: "**{user}** mira para um tiro na cabeça!",
        duel_action_special_cover: "**{user}** mira para um tiro na cabeça mas **{target}** está protegido!",
        ...
        // Roulette Command
        roulette_specify_both: "❌ Por favor, especifique valor da aposta e tipo de aposta!",
        roulette_must_specify_number: "❌ Você deve especificar um número quando apostar em um número específico!",
        roulette_cooldown: "⏰ Calma aí, parceiro! Espere {time} segundos antes de girar novamente.",
        roulette_already_active: "❌ Você já tem um jogo de roleta ativo!",
        roulette_insufficient_tokens: "❌ Você não tem fichas suficientes! Você tem {current} {emoji} mas tentou apostar {bet} {emoji}.",
        ...
        roulette_ui_now_select_amount: "💰 Agora selecione o valor da aposta no menu abaixo",
        ...
        roulette_invalid_number: "❌ Número inválido! Por favor, digite um número entre 0 e 36.",
        // Music Command
        ...
        welcome_panel_description: "Configure mensagens de boas-vindas personalizadas para novos membros do servidor.",
        ...
        welcome_modal_message_placeholder: "Digite texto simples ou JSON com embed completo...",
        ...
        welcome_config_saved_desc: "Sistema de boas-vindas configurado com sucesso.",
        ...
        welcome_error_invalid_channel: "Canal inválido! Forneça um ID de canal de texto válido.",
        welcome_error_invalid_json: "JSON inválido! Verifique a sintaxe.",
        welcome_error_invalid_url: "URL inválida! Use um link começando com http:// ou https://",
        welcome_error_channel_not_found: "Canal não encontrado! Reconfigure o sistema.",
        welcome_status_enabled: "Ativado",
        welcome_status_disabled: "Desativado",
        welcome_enabled_title: "Sistema Ativado!",
        welcome_enabled_desc: "Mensagens de boas-vindas serão enviadas para novos membros.",
        welcome_disabled_title: "Sistema Desativado",
        welcome_disabled_desc: "Mensagens de boas-vindas não serão mais enviadas.",
        welcome_test_error_disabled: "Sistema desativado! Ative primeiro para testar.",
        welcome_test_sent: "Mensagem de Teste Enviada!",
        welcome_test_sent_desc: "Confira a mensagem em",
        welcome_test_error: "Erro ao enviar mensagem de teste. Verifique as permissões do bot.",
        ...
        welcome_import_error_missing: "JSON incompleto! Campos obrigatórios: channelId, message",
        welcome_import_success: "Configuração Importada!",
        welcome_import_success_desc: "Sistema atualizado com a configuração importada.",
        welcome_export_title: "Configuração Exportada",
        welcome_export_desc: "Baixe o arquivo JSON para backup ou compartilhamento.",
        welcome_placeholders_field: "Placeholders",
        welcome_placeholders_list: "`{@user}` - Menção\n`{username}` - Nome\n`{server}` - Servidor\n`{guild.size}` - Total de membros\n`{user.avatar}` - Avatar\n`{guild.icon}` - Ícone do servidor",
        ...
        logs_removed_description: "Os logs não serão mais enviados para nenhum canal.",
        logs_not_configured: "Sistema de logs não está configurado",
        expedition_title: "Expedição ao Deserto",
        expedition_desc: "Embarque em uma expedição perigosa pelo deserto em busca de recursos valiosos!",
        ...
        expedition_complete_desc: "Você voltou da expedição e encontrou recursos valiosos!",
        expedition_rewards_found: "Recursos Encontrados",
        expedition_cooldown_title: "Período de Descanso",
        expedition_cooldown_desc: "Você já fez uma expedição recentemente! Descanse um pouco antes de partir novamente.",
        ...
        expedition_type_party: "👥 **Grupo:** Convidar 1-2 amigos (recompensas divididas)",
        expedition_duration_options: "Opções de Duração",
        expedition_duration_3h: "**3 horas** - Recompensas padrão (1-3 jogadores)",
        expedition_duration_10h: "**10 horas** - Recompensas premium (2-3 jogadores apenas)",
        ...
        expedition_seal_10h_party: "**10 Selos por pessoa** para expedição em grupo de 10h",
        expedition_insufficient_seals: "{cross} Selos insuficientes! Você tem **{current}** mas precisa de **{required}** para esta expedição.",
        expedition_rewards_3h: "Recompensas (expedição 3h)",
        expedition_rewards_10h: "Recompensas (expedição 10h)",
        expedition_choose_wisely: "🏜️ Escolha com sabedoria! Recompensas são divididas entre os membros do grupo.",
        ...
        expedition_solo_choose_duration: "{cowboy} Expedição Solo - Escolha a Duração",
        expedition_solo_select: "Selecione quanto tempo quer gastar nesta expedição:",
        ...
        expedition_party_choose_duration: "{cowboys} Expedição em Grupo - Escolha a Duração",
        expedition_party_select: "Selecione a duração da expedição. Você pode convidar amigos depois:",
        expedition_3h_party_label: "{clock} 3 Horas",
        expedition_3h_party_desc: "**1-3 jogadores permitidos**\nRecompensas padrão divididas",
        expedition_10h_party_label: "{clock} 10 Horas",
        expedition_10h_party_desc: "**2-3 jogadores obrigatórios**\nRecompensas premium divididas",
        expedition_party_title: "{cowboys} Grupo de Expedição - {duration}",
        expedition_party_forming: "<@{leader}> está formando um grupo de expedição!",
        ...
        expedition_party_rewards_equally: "Divididas igualmente entre todos os membros",
        expedition_party_footer: '🏜️ Clique em "Entrar no Grupo" para participar ou "Iniciar Expedição" quando estiver pronto!',
        ...
        expedition_party_full: "{cross} Este grupo de expedição está cheio! (máx 3 membros)",
        expedition_already_active: "{cross} Você já tem uma expedição ativa!",
        expedition_on_cooldown: "{cross} Você ainda está descansando! Intervalo: {timeLeft}",
        expedition_joined_party: "{check} Você entrou no grupo de expedição de <@{leader}>! ({current}/3)",
        expedition_need_min_players: "{cross} Expedições de 10 horas requerem pelo menos 2 jogadores!",
        expedition_started_title: "🗺️ Expedição Iniciada!",
        expedition_started_desc: "{check} Seu grupo partiu para uma expedição de {duration} pelo deserto!",
        expedition_party_members_label: "{cowboys} Membros do Grupo",
        expedition_estimated_return: "{timer} Retorno Estimado",
        expedition_started_footer: "🏜️ Todos os membros receberão uma DM quando a expedição estiver completa!",
        ...
        expedition_dm_footer: "🏜️ Recompensas automaticamente adicionadas à sua conta!",
        expedition_already_complete: "Sua expedição está completa! Suas recompensas foram automaticamente adicionadas à sua conta quando a expedição terminou.\n\nVocê deve ter recebido uma DM com os detalhes. Confira seu inventário para ver as recompensas!",
        ...
        expedition_cooldown_footer: "🏜️ Descanse e prepare-se para a próxima aventura!",
        expedition_solo_duration_footer: "🏜️ Escolha sua duração",
        expedition_party_duration_footer: "🏜️ As recompensas serão divididas entre todos os membros do grupo",
        expedition_duration_3h_text: "3 horas",
        expedition_duration_10h_text: "10 horas",
        expedition_cooldown_value: "**6 horas**",
        expedition_rewards_3h_value: "{silver} **4.500 - 8.800** Moedas de Prata\n{gold} **9x** Barras de Ouro\n🌾 **2.000 - 6.000** Trigo\n🍯 **10x** Mel\n{star} **+1.000 XP**",
        expedition_rewards_10h_value: "{silver} **35.000 - 55.000** Moedas de Prata\n{gold} **16x** Barras de Ouro\n🌾 **8.000 - 15.000** Trigo\n🍯 **35x** Mel\n{star} **+3.500 XP**",
        // Embed Builder
        ...
        eb_modal_basic_desc_placeholder: "Digite a descrição... (use \\n para quebras)",
        ...
        eb_export_description_file: "O JSON está muito grande! Baixe o arquivo anexado:",
        // Guild System
        guild_welcome_title: "🏰 Sistema de Guildas",
        guild_welcome_desc: "**Bem-vindo ao Sistema de Guildas do Sheriff Rex!**\n\n" +
            "🤝 **O que são Guildas?**\n" +
        ...
        guild_request_dm_error: "⚠️ Não foi possível enviar DM ao líder. O pedido foi criado!",
        ...
        guild_request_accepted_desc: "Parabéns! Você agora faz parte da guilda **{guild}**!",
        guild_request_rejected_title: "📝 Pedido Recusado",
        guild_request_denied_title: "❌ Pedido Negado",
        guild_request_denied_desc: "Seu pedido para entrar na guilda **{guild}** foi recusado pelo líder.",
        ...
        server_setup_analyzing_desc: "Analisando sua solicitação e planejando a estrutura do servidor...",
        ...
        server_setup_cleanup_desc: "Deseja limpar canais/cargos/categorias existentes antes de criar a nova estrutura?",
        server_setup_cleanup_warning: "⚠️ **ATENÇÃO:** Isso irá **DELETAR PERMANENTEMENTE**:\n• Todos os canais (exceto este)\n• Todas as categorias\n• Todos os cargos (exceto @everyone e cargos do bot)\n\n**Esta ação é irreversível!**",
        ...
        server_setup_cleaning_desc: "Removendo canais, categorias e cargos existentes...",
        server_setup_cleaned: "✅ Servidor Limpo!",
        server_setup_cleaned_desc: "Removidos:\n• **{channels}** canais\n• **{categories}** categorias\n• **{roles}** cargos",
        ...
        server_setup_success_desc: "Sheriff Rex configurou seu servidor, parceiro! 🤠",
        ...
        server_setup_error_footer: "Tente reformular sua solicitação ou contate um admin",
        ...
        server_setup_timeout_desc: "Você não respondeu a tempo. Configuração cancelada.",
        server_setup_try_again: "Use /criaservidor novamente para tentar",
        server_setup_cancelled: "❌ Configuração Cancelada",
        server_setup_cancelled_desc: "A configuração do servidor foi cancelada pelo usuário.",
        server_setup_ai_error: "IA retornou JSON inválido. Tente reformular sua solicitação.",
        server_setup_invalid_structure: "Estrutura inválida da IA. Faltando cargos ou categorias.",
        warehouse_title: "Armazém do Estado",
        warehouse_desc: "Mercado compartilhado onde todos podem vender e comprar recursos!",
        ...
        warehouse_out_of_stock: "Não há {resource} em estoque! Aguarde outros jogadores venderem.",
        ...
        warehouse_enter_amount: 'Digite a quantidade que deseja {action} (ou "cancelar" para voltar):',
        ...
        warehouse_insufficient_items: "Você não tem {amount} unidades de {resource}!",
        warehouse_insufficient_stock: "Não há {amount} unidades disponíveis! Estoque atual: {stock} unidades.",
        warehouse_insufficient_silver: "Você não tem Silver Coins suficientes!\nNecessário: **{needed}**\nVocê tem: **{current}**",
        warehouse_error_processing: "Erro ao processar {action}. Estoque insuficiente.",
        ...
        warehouse_added_inventory: "Os recursos foram adicionados ao seu inventário!",
        warehouse_timeout: "Tempo esgotado! Use `/armazem` novamente.",
        warehouse_cancelled: "cancelada.",
        ai_cooldown: "Whoa there, partner! Give me {time} seconds to catch my breath before ya ask another question!",
        ai_not_configured: "**OpenRouter API não está configurado**\n\nO administrador do bot precisa configurar a variável de ambiente `OPENROUTER_API_KEY`.\n\nObtenha sua chave API em: https://openrouter.ai/keys",
        ...
        models_not_configured: "**OpenRouter API não está configurado**\n\nO administrador do bot precisa configurar a variável de ambiente `OPENROUTER_API_KEY`.\n\nObtenha sua chave API em: https://openrouter.ai/keys",
        models_no_models: "Nenhum modelo encontrado que corresponda aos seus critérios.",
        ...
        models_more_desc: "Há {count} modelos adicionais disponíveis. Visite https://openrouter.ai/models para ver todos os modelos.",
        models_error: "Erro:",
        ...
        mute_footer: "O membro será automaticamente dessilenciado quando o tempo expirar",
        ...
        addreward_footer: "Membros receberão este role ao atingir o nível especificado",
    ...
    "en-US": {
        ...
        auto_daily_reward_desc: "*The sheriff passed through town and left a gift for you!*\n\n" +
            "╭─────────────────╮\n" +
            "│ {token} **{tokenAmount}** Saloon Tokens\n" +
        ...
        auto_daily_reward_footer: "Next rewards tomorrow at {hour}:00 • Sheriff Rex",
        auto_daily_inventory_full_title: "⚠️ Inventory Full!",
        auto_daily_inventory_full_desc: "*The sheriff tried to deliver your rewards, but your backpack is full!*\n\n" +
        ...
        mine_blocked_expedition_desc: "You can't mine while on an active expedition. Complete the expedition first!",
        mine_blocked_expedition_footer: "Come back when the expedition is over to mine again.",
        ...
        bankrob_success_desc: "**{user1}** and **{user2}** successfully robbed the bank and escaped!\n\nYou managed to escape with the loot!",
        ...
        roubo_warning_text: "If the heist fails, ALL participants will become wanted!",
        ...
        roubo_need_silver: "❌ You need **{amount}** Silver Coins to join this rustling!",
        ...
        roubo_progress_desc: "🤫 The cowboys are working quietly to steal the cattle without being seen!",
        ...
        roubo_success_desc: "🐴 The group rustled {cattle} heads of cattle!\n\nYou managed to escape unseen and divided the cattle!",
        roubo_distribution: "📦 Cattle Distribution",
        roubo_added_inventory: "✅ The cattle has been added to each participant's inventory!",
        ...
        roubo_insufficient_silver: "❌ One of the participants doesn't have enough silver! Heist cancelled.",
        roubo_random_word: "🎲 random",
        roubo_progress_label: "📊 Progress",
        roubo_in_jail_cooldown: "🔒 You're in jail!",
        roubo_cooldown_wait: "⏰ Wait {time} seconds before attempting another rustling!",
        roubo_time_remaining_punishment: "⏱️ Time remaining",
        roubo_cattle_word: "cattle",
        roubo_entry_fee_required: "❌ You need **{amount}** Silver Coins to join this rustling!",
        // Middleman Command
        ...
        territory_saloon_business_desc: "Own a bustling saloon in the heart of town! Serve drinks, host events, and watch the coins roll in.",
        territory_saloon_business_benefit_1: "💰 Generate 5,000 Silver Coins daily",
        territory_saloon_business_benefit_2: "",
        territory_gold_mine_shares_name: "Gold Mine Shares",
        territory_gold_mine_shares_desc: "Invest in the richest gold mine in the West! Your shares will bring you steady income from precious metals.",
        territory_gold_mine_shares_benefit_1: "💰 Generate 12,000 Silver Coins daily",
        territory_gold_mine_shares_benefit_2: "⚡ 50% faster mining operations",
        territory_ranch_name: "Ranch",
        territory_ranch_desc: "Build your own ranch with cattle, horses, and wide open plains. A true cowboy's dream come true!",
        ...
        duel_challenge_desc: "**{challenger}** challenges **{opponent}** to a Western duel!\n\n{bet_info}⏰ Accept within 60 seconds!",
        ...
        duel_action_attack_cover: "**{user}** fires a quick shot but **{target}** is behind cover!",
        duel_action_defend: "**{user}** takes cover behind a barrel!",
        duel_action_special: "**{user}** aims for a headshot!",
        duel_action_special_cover: "**{user}** aims for a headshot but **{target}** is behind cover!",
        ...
        roulette_must_specify_number: "❌ You must specify a number when betting on a specific number!",
        roulette_cooldown: "⏰ Hold your horses! Wait {time} more seconds before spinning again.",
        roulette_already_active: "❌ You already have an active roulette game!",
        roulette_insufficient_tokens: "❌ You don't have enough tokens! You have {current} {emoji} but tried to bet {bet} {emoji}.",
        ...
        roulette_ui_now_select_amount: "💰 Now select the bet amount in the menu below",
        roulette_ui_ready: "READY TO SPIN!",
        roulette_ui_click_to_spin: "🎯 Click the button below to spin the roulette!",
        ...
        roulette_invalid_number: "❌ Invalid number! Please enter a number between 0 and 36.",
        // Music Command
        ...
        welcome_panel_description: "Configure custom welcome messages for new server members.",
        ...
        welcome_modal_message_placeholder: "Enter plain text or JSON with complete embed...",
        ...
        welcome_error_invalid_channel: "Invalid channel! Provide a valid text channel ID.",
        welcome_error_invalid_json: "Invalid JSON! Check syntax.",
        welcome_error_invalid_url: "Invalid URL! Use a link starting with http:// or https://",
        welcome_error_channel_not_found: "Channel not found! Reconfigure the system.",
        ...
        welcome_import_placeholder: '{"channelId": "...", "message": "...", ...}',
        welcome_import_error_missing: "Incomplete JSON! Required fields: channelId, message",
        ...
        warnings_warn_entry: "**Warning #{id}**\n**Reason:** {reason}\n**Moderator:** {moderator}\n**Date:** {date}",
        ...
        addreward_footer: "Members will receive this role when they reach the specified level",
        addreward_already_exists: "A reward already exists for level {level}!",
        expedition_title: "Desert Expedition",
        expedition_desc: "Embark on a dangerous expedition through the desert in search of valuable resources!",
        ...
        expedition_complete_desc: "You returned from the expedition and found valuable resources!",
        expedition_rewards_found: "Resources Found",
        expedition_cooldown_title: "Rest Period",
        expedition_cooldown_desc: "You've already done an expedition recently! Rest a bit before departing again.",
        ...
        expedition_type_party: "{cowboys} **Party:** Invite 1-2 friends (rewards divided)",
        expedition_duration_options: "Duration Options",
        expedition_duration_3h: "**3 hours** - Standard rewards (1-3 players)",
        expedition_duration_10h: "**10 hours** - Premium rewards (2-3 players only)",
        ...
        expedition_seal_10h_party: "**10 Seals per person** for 10h party expedition",
        expedition_insufficient_seals: "{cross} Insufficient seals! You have **{current}** but need **{required}** for this expedition.",
        expedition_rewards_3h: "Rewards (3h expedition)",
        expedition_rewards_10h: "Rewards (10h expedition)",
        expedition_choose_wisely: "🏜️ Choose wisely! Rewards are divided among party members.",
        ...
        expedition_solo_choose_duration: "{cowboy} Solo Expedition - Choose Duration",
        expedition_solo_select: "Select how long you want to spend on this expedition:",
        ...
        expedition_party_choose_duration: "{cowboys} Party Expedition - Choose Duration",
        expedition_party_select: "Select expedition duration. You can invite friends after selecting:",
        expedition_3h_party_label: "{clock} 3 Hours",
        expedition_3h_party_desc: "**1-3 players allowed**\nStandard rewards divided",
        expedition_10h_party_label: "{clock} 10 Hours",
        expedition_10h_party_desc: "**2-3 players required**\nPremium rewards divided",
        ...
        expedition_party_footer: '🏜️ Click "Join Party" to join or "Start Expedition" when ready!',
        ...
        expedition_party_full: "{cross} This expedition party is full! (max 3 members)",
        expedition_already_active: "{cross} You already have an active expedition!",
        expedition_on_cooldown: "{cross} You're still resting! Cooldown: {timeLeft}",
        expedition_joined_party: "{check} You joined <@{leader}>'s expedition party! ({current}/3)",
        expedition_need_min_players: "{cross} 10-hour expeditions require at least 2 players!",
        expedition_started_title: "🗺️ Expedition Started!",
        expedition_started_desc: "{check} Your party departed on a {duration} expedition through the desert!",
        expedition_party_members_label: "{cowboys} Party Members",
        expedition_estimated_return: "{timer} Estimated Return",
        expedition_started_footer: "🏜️ All members will receive a DM when the expedition is complete!",
        ...
        expedition_already_complete: "Your expedition is complete! Your rewards were automatically added to your account when the expedition finished.\n\nYou should have received a DM with the details. Check your inventory to see your rewards!",
        ...
        expedition_party_duration_footer: "🏜️ Rewards will be divided among all party members",
        expedition_duration_3h_text: "3 hours",
        expedition_duration_10h_text: "10 hours",
        expedition_cooldown_value: "**6 hours**",
        expedition_rewards_3h_value: "{silver} **4,500 - 8,800** Silver Coins\n{gold} **9x** Gold Bars\n🌾 **2,000 - 6,000** Wheat\n🍯 **10x** Honey\n{star} **+1,000 XP**",
        expedition_rewards_10h_value: "{silver} **35,000 - 55,000** Silver Coins\n{gold} **16x** Gold Bars\n🌾 **8,000 - 15,000** Wheat\n🍯 **35x** Honey\n{star} **+3,500 XP**",
        // Embed Builder
        ...
        eb_modal_basic_desc_placeholder: "Enter description... (use \\n for breaks)",
        ...
        eb_export_description_file: "JSON is too large! Download the attached file:",
        // Guild System
        guild_welcome_title: "🏰 Guild System",
        guild_welcome_desc: "**Welcome to Sheriff Rex Guild System!**\n\n" +
            "🤝 **What are Guilds?**\n" +
        ...
        guild_request_dm_error: "⚠️ Could not send DM to leader. Request was created!",
        ...
        guild_request_accepted_desc: "Congratulations! You are now part of the **{guild}** guild!",
        guild_request_rejected_title: "📝 Request Declined",
        guild_request_denied_title: "❌ Request Denied",
        guild_request_denied_desc: "Your request to join the **{guild}** guild was declined by the leader.",
        ...
        server_setup_analyzing_desc: "Analyzing your request and planning the server structure...",
        server_setup_planning: "📋 Server Structure Plan",
        server_setup_creating: "*Creating now...*",
        server_setup_cleanup_title: "🧹 Server Cleanup",
        server_setup_cleanup_desc: "Do you want to clean up existing channels/roles/categories before creating the new structure?",
        server_setup_cleanup_warning: "⚠️ **WARNING:** This will **PERMANENTLY DELETE**:\n• All channels (except this one)\n• All categories\n• All roles (except @everyone and bot roles)\n\n**This action is irreversible!**",
        ...
        server_setup_cleaning_desc: "Removing existing channels, categories, and roles...",
        server_setup_cleaned: "✅ Server Cleaned!",
        server_setup_cleaned_desc: "Removed:\n• **{channels}** channels\n• **{categories}** categories\n• **{roles}** roles",
        ...
        server_setup_success_desc: "Sheriff Rex has set up your server, partner! 🤠",
        ...
        server_setup_error_footer: "Try rephrasing your request or contact an admin",
        ...
        server_setup_ai_error: "AI returned invalid JSON. Please try rephrasing your request.",
        server_setup_invalid_structure: "Invalid structure from AI. Missing roles or categories.",
        warehouse_title: "State Warehouse",
        warehouse_desc: "Shared marketplace where everyone can sell and buy resources!",
        ...
        warehouse_out_of_stock: "No {resource} in stock! Wait for other players to sell.",
        ...
        warehouse_enter_amount: 'Enter the quantity you want to {action} (or "cancel" to go back):',
        warehouse_action_sell: "sell",
        warehouse_action_buy: "buy",
        warehouse_invalid_amount: "Invalid quantity! Enter a valid number.",
        warehouse_insufficient_items: "You don't have {amount} units of {resource}!",
        warehouse_insufficient_stock: "Not enough {amount} units available! Current stock: {stock} units.",
        warehouse_insufficient_silver: "You don't have enough Silver Coins!\nNeeded: **{needed}**\nYou have: **{current}**",
        warehouse_error_processing: "Error processing {action}. Insufficient stock.",
        ...
        models_not_configured: "**OpenRouter API is not configured**\n\nThe bot administrator needs to set up the `OPENROUTER_API_KEY` environment variable.\n\nGet your API key at: https://openrouter.ai/keys",
        ...
        models_more_desc: "There are {count} more models available. Visit https://openrouter.ai/models to see all models.",
        models_error: "Error:",
    },
    "es-ES": {
        ...
        auto_daily_reward_desc: "*¡El sheriff pasó por el pueblo y dejó un regalo para ti!*\n\n" +
            "╭─────────────────╮\n" +
        ...
        auto_daily_reward_footer: "Próximas recompensas mañana a las {hour}:00 • Sheriff Rex",
        auto_daily_inventory_full_title: "⚠️ ¡Inventario Lleno!",
        auto_daily_inventory_full_desc: "*¡El sheriff intentó entregar tus recompensas, pero tu mochila está llena!*\n\n" +
        ...
        // Roulette Command
        roulette_specify_both: "❌ ¡Por favor, especifica el monto de la apuesta y el tipo de apuesta!",
        roulette_must_specify_number: "❌ ¡Debes especificar un número cuando apuestas a un número específico!",
        roulette_cooldown: "⏰ ¡Espera! Espera {time} segundos más antes de girar nuevamente.",
        roulette_already_active: "❌ ¡Ya tienes un juego de ruleta activo!",
        roulette_insufficient_tokens: "❌ ¡No tienes suficientes fichas! Tienes {current} {emoji} pero intentaste apostar {bet} {emoji}.",
        ...
        roulette_ui_now_select_amount: "💰 Ahora selecciona el monto de la apuesta en el menú abajo",
        roulette_ui_ready: "¡LISTO PARA GIRAR!",
        roulette_ui_click_to_spin: "🎯 ¡Haz clic en el botón abajo para girar la ruleta!",
        ...
        roulette_invalid_number: "❌ ¡Número inválido! Por favor, ingresa un número entre 0 y 36.",
        // Music Command
    ...
    fr: {
        ...
        auto_daily_reward_desc: "*Le shérif est passé en ville et a laissé un cadeau pour vous !*\n\n" +
            "╭─────────────────╮\n" +
        ...
        auto_daily_reward_footer: "Prochaines récompenses demain à {hour}:00 • Sheriff Rex",
        auto_daily_inventory_full_title: "⚠️ Inventaire Plein !",
        auto_daily_inventory_full_desc: "*Le shérif a essayé de livrer vos récompenses, mais votre sac à dos est plein !*\n\n" +
        ...
        // Roulette Command
        roulette_specify_both: "❌ Veuillez spécifier le montant du pari et le type de pari !",
        roulette_must_specify_number: "❌ Vous devez spécifier un numéro lorsque vous pariez sur un numéro spécifique !",
        roulette_cooldown: "⏰ Doucement ! Attendez {time} secondes de plus avant de tourner à nouveau.",
        roulette_already_active: "❌ Vous avez déjà un jeu de roulette actif !",
        roulette_insufficient_tokens: "❌ Vous n'avez pas assez de jetons ! Vous avez {current} {emoji} mais avez essayé de parier {bet} {emoji}.",
        ...
        roulette_ui_now_select_amount: "💰 Maintenant sélectionnez le montant du pari dans le menu ci-dessous",
        roulette_ui_ready: "PRÊT À TOURNER !",
        roulette_ui_click_to_spin: "🎯 Cliquez sur le bouton ci-dessous pour tourner la roulette !",
        roulette_ui_spin: "🎰 TOURNER ROULETTE",
        roulette_ui_not_selected: "Non sélectionné",
        roulette_ui_select_bet_type: "Maintenant choisissez le type de pari ci-dessus",
        roulette_enter_number: "Entrez un numéro (0-36) :",
        roulette_invalid_number: "❌ Numéro invalide ! Veuillez entrer un numéro entre 0 et 36.",
        // Music Command
...
function getLocale(interaction) {
    ...
    if ("user" in interaction && interaction.user?.id) {
        setUserLocale(interaction.user.id, locale.startsWith("pt")
            ? "pt-BR"
...
function tUser(userId, key, params = {}) {
...
function tLocale(locale, key, params = {}) {
    let text = translations[locale][key] || translations["en-US"][key] || key;
    Object.keys(params).forEach((param) => {
        text = text.replace(`{${param}}`, params[param]);
    });
